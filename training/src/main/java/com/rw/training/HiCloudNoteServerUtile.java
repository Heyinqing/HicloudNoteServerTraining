 ...
 * @author shangmi
 */
public class HiCloudNoteServerUtile {
    ...
    static void sendMassage() throws Exception{
     ...
     * @return
     */
    static String[] handlePhone(String[] phoneNumbers){
        ...
        for (String phoneNumber : phoneNumbers){
            ...
            if (replaced.length()==11||!phoneNumber.startsWith("+86")||!phoneNumber.startsWith("86")){
                list.add("+86"+replaced);
            }
        }
